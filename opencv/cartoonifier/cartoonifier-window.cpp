...
Frame* CartoonifierWindow::CreateToolBoxOnce()
{
  ...
  PushButton* pause = new PushButton(icons()->pixel_icon(Icons::PAUSE));
  PushButton* play = new PushButton(icons()->pixel_icon(Icons::PLAY));
  PushButton* stop = new PushButton(icons()->pixel_icon(Icons::REC));
